...
struct pt_struct { int from, to, n_odd, n_prime, n_fib; };
...
// Base MAIN structure, feel free to change if you are not comfortable with that
int main(int argc, char* argv[]) {
  ...
  // -------------------------------- PTHREADS CODE --------------------------------------
  // Hint: don't forget the -lpthread flag while compiling
  ...
  // -------------------------------- OMP CODE --------------------------------------
  // Hint: don't forget the -fopenmp flag, and to set the number of threads either in code or in the shell
  gettimeofday(&tv1, NULL);
